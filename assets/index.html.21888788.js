...
# or, \u53EF\u4EE5\u76F4\u63A5\u4F7F\u7528\u6307\u5B9A\u5E8F\u53F7
hg diff -r 102 -r 101
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><hr><h2 id="on-my-zsh" tabindex="-1"><a class="header-anchor" href="#on-my-zsh" aria-hidden="true">#</a> on-my-zsh</h2>`,33),h=s("\u5728 on-my-zsh \u4E2D\u4F7F\u7528 hg \u7684\u6269\u5C55: "),m={href:"https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/mercurial",target:"_blank",rel:"noopener noreferrer"},t=s("Mercurial plugin"),o=r(`<p>\u9996\u5148\u4E0B\u8F7D\u63D2\u4EF6\u3002</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>git clone https://github.com/zsh-users/zsh-autosuggestions \${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/plugins/mercurial
